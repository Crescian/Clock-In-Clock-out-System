        ...
        <section class="text-gray-600 body-font">
          <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
              <img class="object-cover object-center rounded" alt="hero" src="{{ asset('images/my_profile.jpg') }}" width="400" height="400">
            </div>
            <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
              <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Crescian Lloyd Lanoy</h1>
              <p class="mb-8 leading-relaxed">I am a Full Stack Web Developer with 3 years of experience, eager to continue learning and growing in the programming industry. I developed an simple employee clock-in and out system to showcase my expertise in Laravel development.</p>
              ...
              <p class="text-sm mt-2 text-gray-500 mb-8 w-full">This is just tailwind design.</p>
